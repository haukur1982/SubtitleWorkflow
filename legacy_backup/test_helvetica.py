...
OUTPUT_CLIP = BASE_DIR / "fix_helvetica_clip.mp4"
ASS_PATH = BASE_DIR / "fix_helvetica.ass"

# 1. Generate ASS (Uses updated publisher.py)
print("Generating ASS with Helvetica...")
srt_to_ass(SRT_PATH, ASS_PATH, style_name="RuvBox")

# 2. Burn Clip (15:20 to 15:40 - The Stacking Zone)
cmd = [
    "ffmpeg", "-y",
    "-ss", "00:15:20",
    "-t", "20",
