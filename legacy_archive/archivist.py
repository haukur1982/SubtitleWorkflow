...
def run_archivist():
    ...
    while True:
        system_health.update_heartbeat("archivist")
        
        # Scan for ANY completed .mp4 files in DELIVERABLES
        for file in DELIVERABLES_DIR.glob("*.mp4"):
            ...
            try:
                ...
                pass # File might have been moved
